...
namespace PluginMaster
{
    public static partial class Shortcuts
    {
        ...
        [UnityEditor.ShortcutManagement.Shortcut(PWB_TOGGLE_GRID_LOCK_SHORTCUT_ID)]
        ...
        [UnityEditor.ShortcutManagement.Shortcut(PWB_TOGGLE_PICKER_SHORTCUT_ID, KeyCode.P,
            UnityEditor.ShortcutManagement.ShortcutModifiers.Shift | UnityEditor.ShortcutManagement.ShortcutModifiers.Alt)]
